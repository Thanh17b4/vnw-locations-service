...
@location_router.post('/locations', status_code=201)
...
@location_router.get('/locations/{id}', status_code=200)
...
@location_router.get('/locations', status_code=200)
...
@location_router.put('/locations/{id}', status_code=200)
